    ...
    <Box sx={{ m: 3 }}>
      ...
      <Typography variant="body1">
        ...
        <ul>
          ...
          <li>
            Backend: C#, Dotnet 8, Entity Framework, SQL Server, JWT, Swagger
          </li>
        </ul>
      </Typography>
      ...
      <Typography variant="body1">
        ...
        <ul>
          ...
          <li>
            Theme changing with different Game Types: Depending on the game
            type, the theme dynamically adjusts, altering the color scheme of
            number selections, lottery displays, and tickets.
          </li>
          <li>
            User Authentication: Users remain logged in after refreshing the
            page, thanks to JWT stored in local storage. In the event of refresh
            failure or expired tokens, users are redirected to the login page
            with token deletion.
          </li>
          <li>
          ...
          <li>
            ...
            ensuring retrieval after page refreshes when selecting the game
            type.
          </li>
          <li>
      ...
      <Typography variant="body1">
        ...
        <ul>
          ...
          <li>
            Incorporation of designer or UI/UX input to enhance aesthetic
            appeal.
          </li>
        </ul>
      </Typography>
      ...
      <Typography variant="body1">
        ...
        <ul>
          <li>
            Development of an administrative interface for managing users,
            games, tickets, and balances.
          </li>
        </ul>
      </Typography>
    </Box>
